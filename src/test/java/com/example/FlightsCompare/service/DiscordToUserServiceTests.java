...
import com.example.FlightsCompare.service.impl.DiscordToUserServiceImpl;
...
public class DiscordToUserServiceTests {
    ...
    public void setUp() {
        ...
        oauth2ToUserService = new DiscordToUserServiceImpl(oAuth2Fetcher, userRepository, linkedProviderRepository);
    }
